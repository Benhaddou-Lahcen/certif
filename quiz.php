...
<section class="courses">
   ...
   <div class="heading" id="timer">Time left : </div>


   <form method="post" action="./controller/quizController.php?action=post" class="box-container" id="quiz-container">
      <div class="box">
         <button type="submit" class="inline-btn" onclick="submitQuiz()">Submit</button>
      </div>
   </form>
