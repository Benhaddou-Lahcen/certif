...
<section class="watch-video">
   ...
   if (isset($_POST['vid'])) {
      ...
      $vid = basename($_POST['vid']); // basename removes any directory path from the input
      $videoPath = "./images/" . $vid;
   } else {
      // Default video if no vid is provided
      $videoPath = "./images/default-video.mp4";
   }
   ?>

   <div class="video">
      <video src="<?php echo htmlspecialchars($videoPath); ?>" controls poster="images/post-1-1.png" id="video"></video>
   </div>
   <!-- <?php
